...
export const baseRows = [
  ...
  [
    ...
    { label: "ins", code: "Insert", width: "40px", color: "dark-red", align: "tl" },
    // Delete becomes Print Screen
    { label: "prt sc", code: "PrintScreen", width: "45px", color: "dark-red", align: "tl" },
    // Far right: Delete with Lightbulb icon (was Insert with Lightbulb)
    { label: "del", icon: '', code: "Delete", width: "45px", color: "dark-red", align: "tl" },
  ],
  ...
  [
    ...
    // PageDown → PageUp
    { label: "page up", code: "PageUp", width: "40px", color: "dark-red", align: "tl" },
  ],
  ...
  [
    ...
    // Home → PageDown
    { label: "page down", code: "PageDown", width: "40px", color: "dark-red", align: "tl" },
  ],
